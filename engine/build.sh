...
cd .. &&
gcc -o ./trench -I $(ocamlc -where) util.c game_state.c field_scan.c events.c resource_registry.c visual.c main.c ./_build/compiler_module.a -lcurses -pthread -lzstd -lc -lm -ldl &&
rm -r _build