...
cd .. &&
gcc -o ./trench -I $(ocamlc -where) util.c location.c game_state.c color.c entity.c fields.c array_list.c player_list.c vehicles.c entity_list.c event_list.c events.c resource_registry.c player.c visual.c main.c ./_build/compiler_module.a -lcurses -pthread -lzstd -lc -lm -ldl &&
rm -r _build