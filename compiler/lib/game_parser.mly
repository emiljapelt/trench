...
%token COMMA SEMI COLON EOF STAR FEATURES COLOR INFINITE MANUAL TRUE FALSE DEBUG VIEWPORT AUTO_START AUTO_RESIZE
...
game_setup_part:
  ...
  | EXEC_MODE COLON DEFAULT SEMI? { ExecMode DefaultExec }
  ...
  | AUTO_RESIZE COLON TRUE SEMI? { AutoResize true }
  | AUTO_RESIZE COLON FALSE SEMI? { AutoResize false }
;
