...
%token PLAYER RESOURCES THEMES TIME_SCALE SEED ACTIONS STEPS MODE MAP NUKE NAME TEAM ORIGIN FILE EXEC_MODE SYNC ASYNC
%token THROW_LIMIT SHOOT_LIMIT
...
game_setup_part:
  ...
  | SHOOT_LIMIT COLON CSTINT SEMI? { ShootLimit $3 }
  | THROW_LIMIT COLON CSTINT SEMI? { ThrowLimit $3 }
;